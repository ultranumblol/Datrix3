 ...
 */
class DialogDirAdapter(context: Context) : RecyclerArrayAdapter<PersonalFilelistData.result2>(context) {
    ...
    private inner class SpaceAdapterViewholder(itemView: ViewGroup) : BaseViewHolder<PersonalFilelistData.result2>(itemView, R.layout.item_dialogdir) {
