...
class ShareToMeFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun initview(view: View) {
        ...
        rv!!.apply {
            ...
            adapter = rvadapter
            setRefreshListener(this@ShareToMeFragment)
    ...
    private fun initdata() {
        ...
        HttpUtil.instance.apiService().linklist_pubsee(Someutil.getToken(), Someutil.getUserID())
    ...
    override fun getLayoutitem(): Int {
        ...
        return R.layout.fragment_share_tome;
    }
